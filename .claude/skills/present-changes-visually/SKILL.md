...
this project's Git conventions in `AGENTS.md` (SE-EDU commit-message
convention): an imperative subject and a body explaining what changed and why.
...
Adapted from the `present-changes-visually` Codex skill at
[se-edu/skill-present-changes-visually](https://github.com/se-edu/skill-present-changes-visually),
retargeted from `.codex/skills/` to `.claude/skills/` for use in this repo.
